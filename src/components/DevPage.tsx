...
// ── BOS → ZRH · 2026-04-10 · Air Canada Aeroplan ─────────────────────────
const BOS_ZRH_RESULT: FlightResult = {
  ...
  program_logo_url: 'https://logo.clearbit.com/aeroplan.com',
  carrier_logos: {
  ...
  miles: 60000,
  taxes_usd: 77.59,
  arb_miles_cost_usd: 1458.0,
  arb_miles_cost_promo_usd: 972.0,
  arb_price_usd: 1535.59,
  arb_price_promo_usd: 1049.59,
  cash_price_usd: 4200,
  cash_price_source: 'google_flights',
  savings_usd: 2664,
  value_ratio: 2.74,
  ...
  buy_miles_info: {
    ...
    cost_at_standard: 1458.0,
    cost_at_promo: 972.0,
    total_at_standard: 1535.59,
    total_at_promo: 1049.59,
    min_purchase: 1000,
    max_purchase: 150000,
